...
Download the pretrained weight from https://mega.nz/folder/igAEnRDa#XScwb0Y6eBel5G43t6YdvQ
"""
...
netF.load_state_dict(torch.load("weights_adapting_KonIQ10k.pt")['netF_dict'])

netQ = nn.DataParallel(netQ().cuda())
netQ.load_state_dict(torch.load("weights_adapting_KonIQ10k.pt")['netQ_dict'])
